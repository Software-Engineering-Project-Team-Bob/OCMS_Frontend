...
const StudentSubmission = () => {
    ...
    const getSubmission = () => {
        setLoading(true);
        axios.post("https://ocms-backend.vercel.app/classes/getSubmission", {
    ...
    const getClassDetails = () => {
        ...
        axios.post("https://ocms-backend.vercel.app/classes/getClassroom", 
        {
            classCode: classCode
        },
        {
    ...
    const submitFile = () => {
        ...
        uploadTask.on('state_changed', console.log, console.error, () => {
            getDownloadURL(uploadTask.snapshot.ref).then((firebaseURL) => {
                    // .then(firebaseURL => {
                    return axios.post('https://ocms-backend.vercel.app/classes/submitAssignment', {
                        assignmentId: assignmentId,
    ...
    const unSubmitFile = () => {
        setLoading(true);
        axios.delete("https://ocms-backend.vercel.app/classes/deleteSubmission", {
            data: {
                assignmentId: assignmentId,
                userEmail: userData.userEmail
            }
